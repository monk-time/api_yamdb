...
@pytest.mark.django_db(transaction=True)  # noqa: PLR0904
class Test01UserAPI:
    ...
    def test_04_02_users_get_search(
        ...
        assert 'results' in reponse_json, msg
        assert isinstance(reponse_json.get('results'), list), msg
    ...
    def test_10_01_users_me_patch(
        ...
        for client, visitor in (
            ...
            updated_user = django_user_model.objects.filter(
